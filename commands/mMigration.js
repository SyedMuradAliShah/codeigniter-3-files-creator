...
module.exports = function (vscode, fs, path, pathdir) {
    vscode.window.showInputBox({
        ...
        if (val.length == 0) {
            ...
            var pathfile = path.join(pathdir + "/application/migrations", FileTimeStamp + val) + ".php";
...
/* End of file ` + FileTimeStamp + val + `.php */
                    ...
                    vscode.window.showInformationMessage('Migration table has been created successfully! ');
